import { AppointmentForm } from "@/pages/components/AppointmentForm";
    ...
    <>
      {/* <Head>
        <link
          rel="stylesheet"
          type="text/css"
          href="../../cms/includes/on40glgl6yz.2203240648002.css"
              ...
              <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
                <div className="flair-border" data-content="true">
                  ...
                  >
                    ...
                    <h5>Address</h5>
                    <div>301 Hospital Drive (Building A), Suite No. 140</div>
                    <div>Corsicana, Texas 75110</div>
                    <div>
                      <Link
                        rel="noreferrer"
